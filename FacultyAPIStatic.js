...
//Insert Faculty Data
app.post('/faculty/insertfaculty', (req, res) => {
...
//Update Faculty Data
app.patch('/faculty/updateFaculty', (req, res) => {
  const id = req.body.id

  const data = faculties[faculties.findIndex(temp => temp.id == id)]

  faculties[data] = req.body
...
//Delete Faculty Data
app.delete('/faculty/deleteFaculty', (req, res) => {
  const id = req.body.id
  const index = faculties[faculties.findIndex(temp => temp.id == id)]
